    ...
    public Parent analyticsPage() {
        ...
        top_airline_analytics_pane_button.setOnAction(value -> {
            try {
                ...
                name_column.setCellValueFactory(
                 airline -> new ReadOnlyStringWrapper(airline.getValue().name)
                );
        ...
        top_frequent_flyer_analytics_pane_button.setOnAction(value -> {
            try {
                ...
                name_column.setCellValueFactory(
                    customer -> new ReadOnlyStringWrapper(customer.getValue().name())
                );
        ...
        var platinum_customer_frequent_flyer_month_analytics_pane_button= new Button("Frequent Flying Month for Platinum Customers");
        platinum_customer_frequent_flyer_month_analytics_pane_button.setOnAction(value -> {
            try {
                var months= repository.getFrequentFlyerMonth();
                var table = new TableView<Month>(FXCollections.(months));

                // Set the columns
                var name_column = new TableColumn<Month, String>("Month");
                name_column.setCellValueFactory(
                    Month -> new ReadOnlyStringWrapper(Month.getValue().name())
                );
